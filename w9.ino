    ...
    <head>\
      <style>\
        body{ display: flex; flex-direction: column;}\
         a { background: #BF7277; width: 200px; height: 50px; margin: 20px; font-size: 30pt; text-decoration: none;}\
      </style>\
    </head>\
    <body>\
  ...
  <!DOCTYPE html>\
   <html>\
    <head>\
      <style>\
        body{ display: flex; flex-direction: column;}\
         a { background: #BF7277; width: 150px; height: 50px; margin: 20px; font-size: 25pt; text-decoration: none;}\
      </style>\
    </head>\
    <body>\
      <h1>LED OPEN</h1>\
